...
### 詳細
- **統合情報表示**: 選択した最大3つのレシピについて、以下の情報をまとめて表示する。
  - 選択したレシピ名と画像のリスト
  - **必要な全材料リスト**（重複する材料はまとめる）
  - 各レシピの元のステップ数と想定時間の合計
- **調理開始のトリガー**: この画面にある「調理開始」ボタンを押すことで、次の「同時調理ナビゲーション機能」が開始される。
...
- **ステップ進行管理**:
  ...
  - 完了したステップと未完了のステップは視覚的に区別できるように表示する（例：チェックマーク、グレーアウト）。
...
- **履歴一覧表示**: ユーザーはマイページなどで過去の調理履歴を一覧で確認できる。
